...
#     try:
#         messages = [
#             {"role": "system", "content": "You are a helpful course advisor. Use the provided course information to answer questions accurately and concisely."},
#             {"role": "user", "content": f"Using this course information:\n{context}\n\nPlease answer this question: {query}"}
#         ]
...
#         retrieved_courses = retrieve_course(query)
        
#         if retrieved_courses:
#             # Create context from retrieved courses
#             context = "\n".join([f"{course}\nLink: {link}" for course, link, _ in retrieved_courses])
